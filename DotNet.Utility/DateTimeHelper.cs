...
namespace DotNet.Utility
{
    ...
    {
        #region 取得日期字符串，按照年月日时分秒毫秒，返回如：2008_08_12_08_56_002
        /// <summary>
        /// 取得日期字符串，按照年月日时分秒毫秒，返回如：2008_08_12_08_56_002
        /// </summary>
        public static string GetDateStr()
        {
            ...
            s += myDateTime.Year + "_" +
                myDateTime.Month.ToString().PadLeft(2,'0') + "_" +
                myDateTime.Day.ToString().PadLeft(2, '0') + "_" +
                myDateTime.Hour.ToString().PadLeft(2, '0') + "_" +
                myDateTime.Minute.ToString().PadLeft(2, '0') + "_" +
                myDateTime.Second.ToString().PadLeft(2, '0') + "_" +
                myDateTime.Millisecond.ToString().PadLeft(3, '0');
            return s;
        }
        #endregion
