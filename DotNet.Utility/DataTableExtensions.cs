...
namespace DotNet.Utility
{
    ...
    public static class DataTableExtensions
    {
        ...
        /// <param name="columns">转换的列名list,可选</param>
        /// <returns></returns>
        public static DataTable ToDataTable<T>(this IEnumerable<T> list, List<string> columns = null)
        {
            //创建属性的集合
        ...
        {
            Dictionary<string, object> where = CommonExtensions.DynamicToDictionary(jParams);
            foreach (DataRow row in dt.Rows)
            {
                var macthingCount = 0;
